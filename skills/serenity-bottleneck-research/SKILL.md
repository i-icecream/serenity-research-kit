...
description: Personal version of muxuuu/serenity-skill for source-backed supply-chain bottleneck research. Use for AI/semi/technology value-chain mapping, A-share/HK/US stock screening, single-company thesis challenges, "is this company a real bottleneck?", "用 Serenity 的方式看", "产业链/供应链/卡点/瓶颈", "find unknown bottlenecks", candidate ranking, evidence chains, red flags, and next verification steps. Research support only; no trade execution.
license: MIT
