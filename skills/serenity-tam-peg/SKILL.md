---
name: serenity-tam-peg
description: Personal Serenity valuation module based on haskaomni's TAM-Adj-PEG framework. Evaluate a stock's valuation by adjusting traditional PEG with TAM runway and business quality. Use when the user provides a ticker or asks whether a growth stock's valuation is cheap, expensive, TAM-supported, runway-supported, quality-adjusted, or suitable as core growth, high-beta growth, turnaround, option-like, or cyclical exposure.
---
